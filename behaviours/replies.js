...
module.exports = {
  ...
  texts: {
    ...
    practiceRule: "Today I'll be taking only a single bet. I'm sending you the odds, right now. To place a bet, reply with the _BET ID_, a space, the outcome (H,A or X-for draw), as space and then the amount in credits you want to wager.",
