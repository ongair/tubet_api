...
module.exports = {
  ...
  teams: {
    ...
    dynamo: { full: 'Dynamo Kiev', short: 'DYK' },
    benfica: { full: 'Benfica', short: 'BEN' },
    napoli: { full: 'SSC Napoli', short: 'NAP' },
    besiktas: { full: 'Besiktas', short: 'BES' },
    psv: { full: 'PSV Eindhoven', short: 'PSV' },
    rostov: { full: 'FC Rostov', short: 'ROS' },
    juventus: { full: 'Juventus', short: 'Juve' },
    sevilla: { full: 'Sevilla', short: 'Sev' },
    lyon: { full: 'Lyon', short: 'Lyon' },
    basel: { full: 'Basel', short: 'Basel'},
    gladbach: { full: 'Borussia Mönchengladbach', short: 'BMG'},
    barca: { full: 'Barcelona FC', short: 'Barca' },
    atletico: { full: 'Atletico Madrid', short: 'ATM'},
    ...
    ludogorets: { full: 'Ludogorets Razgrad', short: 'LUD'},
    psg: { full: 'Paris St Germain', short: 'PSG'},
